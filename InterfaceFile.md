...
请求:
 ...
 ---- | ----- | ------ | ------  | ------  
 uId  | 用户Id | 无 | 是 | 无 
 type  | 类型 | 无 | 是 | 0 推荐 按时间或者点赞数或者综合排序 1 关注 按时间排序 
...
### 实名认证 
* 实名认证需要手续费，管理平台可设置手续费，认证成功后减去手续费
请求:
 
 参数 | 释义 | 默认值 | 是否必传 | 备注
 ---- | ----- | ------ | ------  | ------  
 uId  | 用户Id | 无 | 是 | 无 
 authenName  | 真实姓名 | 无 | 否 | 无 
 authenCardNo  | 身份证号 | 无 | 否 | 无 
 authenCardImg0  | 身份证正面照片 | 无 | 否 | 无 
 authenCardImg1  | 身份证反面照片 | 无 | 否 | 无 
 sign  | 参数加密 | 无 | 是 | 无   
...
### 加V申请
* 加V申请需要手续费，管理平台可设置手续费，申请成功后减去手续费
请求:
